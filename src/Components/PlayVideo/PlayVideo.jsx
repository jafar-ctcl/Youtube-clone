 ...
 const { videoId } = useParams()
    ...
    return (
        <div className='play-video'>
           ...
           {apiData? <h3>{apiData ? apiData.snippet.title : "Title Here"}</h3>:""}
          {apiData? <div className="play-video-info">
        ...
        {apiData?<hr />:""}
           {apiData? <div className="publisher">
            ...
            <div className="vid-description">
                ...
                {apiData?<p>{ apiData.snippet.description.slice(0, 250)}</p>:""}
                <hr />
               {apiData? <h4>{apiData ? value_converter(apiData.statistics.commentCount) : 0} Comments</h4>:""}
